//27.	Write a java program to perform the following functions using classes, objects, constructors where essential. Get as input the marks of 5 students in 5 subjects Calculate the total and average. Print the formatted results on the screen
